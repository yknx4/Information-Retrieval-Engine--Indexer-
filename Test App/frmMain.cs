    ...
    public partial class frmMain : Form
    {
        ...
        private void tcpServer1_OnDataAvailable(tcpServer.TcpServerConnection connection)
        {
            ...
            if (data != null)
            {
                ...
                var mEngine = new RetrievalEngine(dataStr);
                var rStr = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(mEngine.Retrieve());
                invokeDelegate del = () =>
                {
